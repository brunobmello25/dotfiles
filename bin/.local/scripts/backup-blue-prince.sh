...
# CONFIGURE THESE:
#
SRC="$HOME/.local/share/Steam/steamapps/compatdata/1569580/pfx/drive_c/users/steamuser/AppData/LocalLow/Dogubomb/BLUE PRINCE"
DEST="$HOME/Documents/backup-blue-prince"
#
