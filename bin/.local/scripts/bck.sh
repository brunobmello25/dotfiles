...
# -----------------------------------------------------------------------------
run_step "rclone sync gdrive_me:/ $BACKUP_DATA/gdrive_me --checksum --log-level INFO"
run_step "rclone sync gdrive_ro:/ $BACKUP_DATA/gdrive_ro --checksum --log-level INFO"
